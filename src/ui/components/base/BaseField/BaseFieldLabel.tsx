  ...
  return (
    <PrimitiveField.Label
      ...
      className={cnState(
        ...
        has-[>[data-slot=field]]:has-data-checked:border-primary/30
        has-[>[data-slot=field]]:has-data-checked:bg-primary/5
        dark:has-[>[data-slot=field]]:has-data-checked:border-primary/20
        dark:has-[>[data-slot=field]]:has-data-checked:bg-primary/10 flex w-fit
        items-center gap-2 leading-snug group-data-[disabled=true]/field:opacity-50
        has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border
        *:data-[slot=field]:p-2.5`,
        `has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col
        has-[>[data-slot=field]]:items-stretch`,
        className,
      )}
    />
  );
